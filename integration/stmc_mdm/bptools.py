# Adpated version of STMC bptools.py for MDM.
# only the f strings are changed to be compatible with python 3.7
...
if __name__ == "__main__":
    ...
    print(f"guoh3dfeats={guoh3dfeats}")
    print("")
